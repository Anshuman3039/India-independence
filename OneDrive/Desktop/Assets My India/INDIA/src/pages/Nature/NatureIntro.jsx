      ...
      >
        ...
        <motion.div variants={fadeUp} className="space-y-4">
          <h1 className="font-serif text-4xl md:text-6xl text-[#171717] font-normal tracking-tight leading-tight">
            One land.<br className="md:hidden" /> Many worlds.
          </h1>
          <p className="text-[#6B6B6B] font-sans text-base md:text-lg leading-relaxed font-light">
            From the Himalayas to the Indian Ocean, India's landscapes support an extraordinary range of climates, ecosystems and life.
          </p>
        </motion.div>

        {/* Large Landscape Photograph */}
        <motion.div 
          variants={fadeUp}
        ...
        >
          <div className="w-full aspect-[16/9] md:h-[50vh] overflow-hidden bg-charcoal/5 shadow-md">
            <img 
              src="/images/nature/nature-intro.jpg" 
              alt="Himalayan or Western Ghats mountain landscape, showing scale and natural beauty of India" 
          ...
          <span className="text-[10px] font-sans text-[#6B6B6B]/60 tracking-wider text-left block mt-2">
            Nature of the Subcontinent • Sourced via Wikimedia Commons
          </span>
        </motion.div>
      </motion.div>
    </section>
