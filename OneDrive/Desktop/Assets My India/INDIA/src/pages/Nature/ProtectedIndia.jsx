...
import { protectedAreas } from '../../data/nature';

export default function ProtectedIndia() {
  ...
  const handleStateSelect = (id, name) => {
    ...
    const data = protectedAreas[targetId] || null;
    setSelectedState({ id: targetId, name: data ? data.state : name, data });
  };
        ...
        <div className="lg:col-span-5 space-y-8 text-left w-full">
          <div className="space-y-4">
            ...
            <h2 className="font-serif text-3xl md:text-4xl lg:text-5xl text-[#171717] font-normal leading-tight">
              Where India protects its wild.
            </h2>
            <p className="text-[#6B6B6B] font-sans text-sm md:text-base leading-relaxed font-light">
              India has set aside networks of national parks, tiger reserves, and biosphere sanctuaries. Click on the map to explore.
            </p>
          </div>
            ...
            <AnimatePresence mode="wait">
              {selectedState ? (
                  ...
                  {selectedState.data?.image && (
                    <div className="w-full aspect-[16/10] overflow-hidden bg-[#171717]/5 border border-[#171717]/5 rounded-[2px] shadow-sm">
                      <img 
                        ...
                        alt={`${selectedState.name} natural landscape`} 
                  ...
                  {selectedState.data ? (
                    <div className="space-y-4 pt-2 border-t border-[#171717]/5">
                      <div className="space-y-0.5">
                        ...
                        <h4 className="font-serif text-base font-medium text-[#171717]">
                      ...
                      <div className="space-y-0.5">
                        ...
                        <p className="text-xs md:text-sm font-sans text-[#171717]">
                          {selectedState.data.ecosystem}
                        </p>
                      </div>
                      ...
                      <div className="space-y-0.5">
                        ...
                        <p className="text-xs md:text-sm font-sans text-[#171717]">
                          {selectedState.data.species}
                        </p>
                      </div>

                      <p className="text-xs md:text-sm font-sans font-light text-[#6B6B6B] leading-relaxed pt-1">
                        {selectedState.data.description}
                      </p>
                    </div>
                  ) : (
                    <div className="pt-4 border-t border-[#171717]/5 space-y-2">
                      ...
                      <p className="text-xs md:text-sm font-sans font-light text-[#6B6B6B] leading-relaxed">
                        Protected areas databases are currently being cataloged. Featured examples initially include Ladakh (JK), Gujarat (GJ), Madhya Pradesh (MP), Assam (AS), and West Bengal (WB).
                      </p>
                    </div>
                  )}
                </motion.div>
                ...
                <div className="h-full flex items-center justify-center p-6 bg-charcoal/5 border border-dashed border-[#171717]/10 text-center text-[#6B6B6B] font-sans text-xs md:text-sm font-light leading-relaxed">
                  Select any state or region on the map to explore representative conservation sanctuaries and national parks.
                </div>
              )}
            </AnimatePresence>
          </div>
          ...
          <div className="w-full max-w-xs pt-4">
            ...
            <select
              ...
              onChange={(e) => {
                ...
                if (id) {
                  const name = protectedAreas[id].state;
