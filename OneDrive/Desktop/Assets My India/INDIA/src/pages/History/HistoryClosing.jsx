...
export default function HistoryClosing() {
  ...
  return (
    <section className="bg-[#F7F4EE] py-28 px-6 md:px-12 max-w-7xl mx-auto border-t border-[#171717]/5 text-center overflow-hidden">
      ...
      >
        ...
        >
          History isn't behind us.<br />It shapes the India we live in today.
        </motion.h2>
        ...
        >
          Every generation inherits a past — and adds something to the story.
        </motion.p>
